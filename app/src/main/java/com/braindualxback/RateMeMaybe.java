...
import com.braindualxback.RateMeMaybeFragment.RMMFragInterface;
...
public class RateMeMaybe implements RMMFragInterface {
	...
	public static void resetData(FragmentActivity activity) {
		...
		if(MainActivity.ENABLE_LOGS) Log.v(TAG, "Cleared RateMeMaybe shared preferences.");
	}
	...
	public void run() {
		...
		if (!isPlayStoreInstalled()) {
			if(MainActivity.ENABLE_LOGS) Log.v(TAG, "No Play Store installed on device.");
